...
export function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={copyLink}
        className="inline-flex h-9 items-center gap-1.5 rounded-md border border-border px-3 text-sm text-muted-foreground transition-colors hover:bg-card hover:text-foreground"
